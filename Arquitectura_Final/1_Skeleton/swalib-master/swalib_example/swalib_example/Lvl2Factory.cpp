...
Lvl2Factory::Lvl2Factory(int _numBalls, float _bigVel, float _medVel, float _smallVel, Entity::EntityType _starterType, GLuint* _texbigball, GLuint* _texmediumball, GLuint* _texsmallball)
{
	numBalls = _numBalls;
	m_bigVel = _bigVel;
	m_medVel = _medVel;
