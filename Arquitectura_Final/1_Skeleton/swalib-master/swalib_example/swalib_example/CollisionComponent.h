...
protected:
	...
	BallCollisionMsg* ballMsg = new BallCollisionMsg();
	VertLimitWorldCollMsg* vertLimitMsg = new VertLimitWorldCollMsg();
	HorLimitWorldCollMsg* horLimitMsg = new HorLimitWorldCollMsg();
	ProjectileCollisionMsg* projMsg = new ProjectileCollisionMsg();
...
protected:
	...
	void SetNewPosition(vec2 _newPos);
};
